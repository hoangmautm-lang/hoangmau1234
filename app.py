...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Mẫu - Trường PTDTBT Tiểu học Thắng Mố - ĐT: 0386822679</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Mẫu - Trường PTDTBT Tiểu học Thắng Mố - ĐT: 0386822679</div>", unsafe_allow_html=True)
